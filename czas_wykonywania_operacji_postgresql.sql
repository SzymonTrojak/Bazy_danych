...
-- DROP DATABASE IF EXISTS "porwnanie_wydajnosci ";

CREATE DATABASE "porwnanie_wydajnosci "
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
...
INSERT INTO geo1.Milion SELECT number
 FROM ID;
 
-- dodawanie index ow bo postgres jest mniej inteligetny
...
CREATE INDEX cyfra ON geo1.Dziesiec(cyfra);
